...
extrasWindow:hide()
extrasWindow.closePanel.onClick = function(widget)
  extrasWindow:hide()
end
...
local addItem = function(id, title, defaultItem, dest, tooltip)
  ...
  widget.item:setImageSource("/images/ui/item-blessed")
...
local addTextEdit = function(id, title, defaultValue, dest, tooltip)
  ...
  widget.text:setText(title)
  widget.text:setFont("verdana-9px-bold")
  widget.textEdit:setText(settings[id] or defaultValue or "")
  widget.textEdit:setImageColor("#363636")
  widget.textEdit:setHeight(18)
  widget.text:setTooltip(tooltip)
...
local addScrollBar = function(id, title, min, max, defaultValue, dest, tooltip)
  ...
  widget.text:setTooltip(tooltip)
  widget.text:setFont("verdana-9px-bold")
  widget.scroll:setImageColor("gray")
